"""Digital Stream, by RAO okedun@yahoo.com
...
PAUSE = 0.1  # (!) Try changing this to other characters.
STREAM_CHARS = ['0', '1']  # (!) Try changing this to other characters.

# Density can range from 0.0 to 1.0:
Density = 0.02  # (!) Try changing to 0.10 or o.30.
...
print('Digital Stream, by RAO okedun@yahoo.com')
print('Press Ctrl-C to quit.')
time.sleep(2)

try:
    # For each column, when the counter is o, no stream is shown.
    # Otherwise, it acts aas a counter for how many times a 1 or 0
    ...
    while True:
        ...
        sys.stdout.flush()  # Make sure test appears on the screen.
        time.sleep(PAUSE)
