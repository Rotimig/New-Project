"""Calender Maker, by by RAO okedun@yahoo.com
Create monthly calenders, saved to a text file and fit for printing.
...
print('Calender Maker, by by  RAO okedun@yahoo.com')
